  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <FormContainer>
        ...
        <FormTitle>تسجيل الدخول للعملاء</FormTitle>
        <FormDescription>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <FormCheckbox
              ...
              {...register('rememberMe')}
            />
            <FormLink href="/forgot-password">نسيت كلمة المرور؟</FormLink>
          </div>
          ...
          <div className="text-center mt-4">
            ...
            <FormLink href="/register">إنشاء حساب جديد</FormLink>
          </div>
          ...
          <div className="text-center">
            ...
            <FormLink href="/provider/login">تسجيل دخول مقدمي الخدمات</FormLink>
          </div>
        </form>
      </FormContainer>
    </div>
